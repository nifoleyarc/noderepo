...
EOF
 ...
 if curl -s --head curl https://server-5.itrocket.net/testnet/empeiria/empeiria_2024-08-22_1072617_snap.tar.lz4 | head -n 1 | grep "200" > /dev/null; then
    curl https://server-5.itrocket.net/testnet/empeiria/empeiria_2024-08-22_1072617_snap.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.empe-chain
  else
